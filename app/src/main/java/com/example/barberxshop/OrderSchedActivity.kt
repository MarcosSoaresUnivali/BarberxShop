...
class OrderSchedActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val intentHome = Intent(contextHome, OrderSchedActivity::class.java)
        ...
        val intent5 = Intent(context5, MainActivity::class.java)
