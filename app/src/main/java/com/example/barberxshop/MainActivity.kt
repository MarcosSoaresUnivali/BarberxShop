...
import com.example.barberxshop.databinding.ActivityMainBinding
import com.google.android.material.snackbar.Snackbar

class MainActivity : AppCompatActivity() {

    private val url: String = "https://github.com/MarcosSoaresUnivali/BarberxShop/blob/main/README.md"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val intentHome = Intent(contextHome, MainActivity::class.java)
        ...
        val intent1 = Intent(context1, LocationActivity::class.java)
